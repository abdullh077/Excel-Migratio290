...
export default function ReceiptPage() {
  ...
  if (!record) {
    return (
      <div dir="rtl" className="min-h-screen flex flex-col items-center justify-center gap-4 bg-white">
        <p className="text-gray-600">البيانات غير موجودة</p>
        <a href="/" className="text-primary underline">العودة للرئيسية</a>
      </div>
    );
  }
  ...
  return (
    <div dir="rtl" className="min-h-screen bg-gray-100 font-sans">
      ...
      <div className="no-print sticky top-0 z-10 flex items-center justify-between gap-2 bg-white border-b px-4 py-3">
        <a href={backHref}>
        ...
        <div className="bg-white border rounded-lg shadow-sm p-8 print:shadow-none print:border-0 print:rounded-none print:p-6">
          ...
          <table className="w-full text-sm border mb-6">
            <thead className="bg-gray-50 text-gray-600 text-xs">
              <tr>
                <th className="border px-3 py-2 text-right font-medium">الحركة</th>
                <th className="border px-3 py-2 text-right font-medium">التفاصيل</th>
                <th className="border px-3 py-2 text-right font-medium">المدفوع</th>
                <th className="border px-3 py-2 text-right font-medium">المتبقي</th>
              </tr>
            </thead>
            <tbody>
              <tr>
